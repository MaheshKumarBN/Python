...
# Shallow copy: copy data from one array to another with different address and
# if we make changes to any one of the array changes will be affected in both array.
